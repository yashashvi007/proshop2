...
const CartScreen = ({match , location , history }) => {
    ...
    return (
        <Row>
            <Col md={8} >
              <h1>Shopping Cart</h1>
              {cartItems.length === 0 ? <Message>Your Cart Is Emtpy <Link to='/' >Go Back</Link></Message> : (
            ...
            <Col md ={4} >
                               <Card>
                                   <ListGroup variant='flush' >
                                       ...
                                       <ListGroup.Item>
                                           <Button type='button' className='btn-block' disabled = {cartItems.legnth === 0} onClick={checkOutHandler}>
                                               Proceed to checkout
                                           </Button>
